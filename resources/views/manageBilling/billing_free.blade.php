...
<div class="">
    ...
    <div class="row">
      ...
      <div class="col-lg-6">
        <div class="payment-header-card">
          ...
          <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#credit-card">
          Add Credit Card
          </button>
        </div>
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            ...
            <div class="row">
              <div class="col-lg-12">	
                <button type="submit" class="btn btn-primary btn-lg btn-block" data-toggle="modal" data-target="#checkout-order" ><span class="fa fa-check"> </span> Order Now</button>
              </div>
            </div>
            <div class="row">
              <div class="col-lg-12">
  ...
  <!-- Modal -->
  <div class="modal fade" id="credit-card" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        ...
        <div class="modal-body">
          <div class="row">
            <div class="col-sm-9">
              ...
              <input class="form-control" required="" name="first_name" type="text" placeholder="Card Number...">
            </div>
            <div class="col-sm-3 card-type">
              <img src="/assets/images/creditcard_visa.png">
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-sm-12">
              ...
              <input class="form-control" required="" name="first_name" type="text" placeholder="Card Holder Name...">
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-sm-12">
              ...
              <input class="form-control" required="" name="first_name" type="text" placeholder="Expire Date...">
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-sm-12">
              <label>CVV</label>
              <input class="form-control" required="" name="first_name" type="text" placeholder="CVV...">
            </div>
          </div>
  ...
  <div class="modal fade" id="checkout-order" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
          <h4 class="modal-title" id="myModalLabel">Order Checkout</h4>
        </div>
        <div class="modal-body">
        <table class="table table-striped">
          ...
          <div class="row card-details">
            <div class="col-sm-8 bill-detail">
              <div class="">
                <h4>Billing Details</h4>
                <div class="row form-group">
                  <div class="col-md-6">
                    <label>First Name</label>
                    <input class="form-control" required="" name="first_name" value="Julius" type="text" placeholder="First Name">
                  </div>
                  <div class="col-md-6">
                    <label>Last Name</label>
                    <input class="form-control" required="" name="last_name" value="Abon" type="text" placeholder="Last Name">
                  </div>
                </div>
                <div class="row form-group">
                  <div class="col-md-12">
                    <label>Company Name</label>
                    <input class="form-control" required="" name="company_name" value="Fusedsoftware" type="text" placeholder="Company Name">
                  </div>
                </div>
                <div class="row form-group">
                  <div class="col-md-8">
                  ...
                  <div class="col-md-4">
                    <label>Phone</label>
                    <input class="form-control" required="" name="phone" type="number" value="+639053158699" placeholder="Phone">
                  </div>
                </div>
                <br><br>
                <div class="row form-group">
                  <div class="col-md-6">
                    <label>Address 1</label>
                    <input class="form-control" required="" name="address1" type="text" value="" placeholder="Address 1">
                  </div>
                  <div class="col-md-6">
                    <label>Address 2</label>
                    <input class="form-control" name="address2" type="text" value="" placeholder="Address 2">
                  </div>
                </div>
                <div class="row form-group">
                  <div class="col-md-6">
                    <label>City</label>
                    <input class="form-control" required="" name="city" type="text" value="" placeholder="City">
                  </div>
                  <div class="col-md-6">
                    <label>Country</label>
                    <input class="form-control" required="" name="country" type="text" value="Philippines" placeholder="Country">
                  </div>
                </div>
                <div class="row form-group">
                  <div class="col-md-6">
                    <label>State</label>
                    <input class="form-control" required="" name="state" value="" type="text" placeholder="State">
                  </div>
                  <div class="col-md-6">
                    <label>Postcode</label>
                    <input class="form-control" required="" maxlength="5" name="post_code" value="" type="text" placeholder="Postcode">
                  </div>
                </div>
              </div>
            </div>
