    ...
    <div class="panel-body">
        ...
        <div class="row marbtm">
    		...
    		<div class="col-lg-3"><br/>
    			<button type="button" class="btn btn-success btn-block" onclick="saveCategory($(this))">Create Tags For Me <i class="fa"></i></button>
    		</div>
    	</div>
    	@if ( count($document_status) )
    		@foreach($document_status as $status )
    			<div class="form-group">
    				<div class="row">
    					<div class="col-md-4">{{ ucfirst($status) }}</div>
    					<div class="col-md-offset-1 col-md-7">
    						<select class="form-control {{ $status }}" name="{{ $status }}">
    							<option value="">Select</option>
								@if ( count($selected_IS_tags) )
        ...
        <div class="row">
    		...
    		<div class="col-lg-3"><br/>
    			<button type="button" class="btn btn-success btn-block" onclick="saveSelections($(this))">Save Tags <i class="fa"></i></button>
    		</div>
    	</div>
    			...
    			<ol class="temapletol">
    				<li>
    					...
    					<div class="row">
    						...
    						<div class="col-lg-8 col-lg-offset-1"><input  class="form-control bg-color" style="width: 100%;" name="Posturl" type="text"  value="{{ url('tools/docusign') }}" readonly></div> <div class="col-lg-3">	</div>
    					</div>
    					<div class="form-group">
        					<div class="row">
                        ...
                        <div class="form-group">
    						<div class="row">
    							...
    							<div class="col-lg-1" align="center"> = </div>
    							<div class="col-lg-4">Name of the document to be sent (IE. ~Company.Name~ Sales Proposal)</div>
    						</div>
    					</div>
    					<div class="form-group">
    						<div class="row">
    							...
    							<div class="col-lg-1" align="center"> = </div>
    							<div class="col-lg-4">Message To Be Sent With The Document (otherwise blank)</div>
    						</div>
    					</div>
    					<div class="form-group">
    						<div class="row">
    							...
    							<div class="col-lg-1" align="center"> = </div>
    							<div class="col-lg-4">1 = send immediately, 0 = create a draft, don't send</div>
    						</div>
    					</div>
    					<div class="form-group">
    						<div class="row">
    							...
    							<div class="col-lg-1" align="center"> = </div>
    							<div class="col-lg-4">1 = get pricing from opportunity, 0 = ignore</div>
    						</div>
    					</div>
    				    @if ($tabs && count($tabs) > 0)
    				        @php $i= 0; $dupTabs = array(); @endphp
                            @foreach ( $tabs as $tab => $val )
    							<div class="form-group">
    								<div class="row">
    									<div class="col-lg-4 col-lg-offset-1 @if ( strpos($tab, '.') !== false || strpos($tab, ' ') !== false ) red-marked  @php $i=1; @endphp @endif" >
    										<input class="form-control bg-color" value="{{ $tab }}">
    										@if ( $val > 1  )
    											<small style="color:#31708f;">This field <strong>{{ $tab }}</strong> appears more once in the template. If you want to write different values to different fields, they need to be uniquely named.</small>
    										@endif
    									</div>
    									<div class="col-lg-1" align="center"> = </div>
    									<div class="col-lg-4">
        						...
        						@if( $i == 1 )
        						    ...
        						    @php $i=0; @endphp
        						@endif
        						@php $dupTabs[] = $tab @endphp
    						@endforeach
    					@endif
                        <div class="row">
                            <div class="col-md-12">
                                <div class="alert alert-info">
                                    <p class="note" style="color: #31708f">
                                        <strong>Some fields are missing?</strong>
                                        <br/>
                                        The default "title", "name" and "company" field for a user cannot be prefilled. As a workaround, use a text field called infscompany or similar and assign it to the user.
                                    </p>
                                </div>
                                 ...
                                 <div class="alert alert-info">
                                    <p class="note" style="color: #31708f">
                                        <strong>Note:</strong>
                                        <br/>
                                        By default, each role will not be able to see other role fields. You can disable this feature by going to <strong> Admin > Sending Settings > Check "When an envelope is sent, write the initial value of the field for all recipients" </strong>
                                    </p>
                                </div>
                            </div>
                        </div>
    					<div class="row"><div style=" width: 20%; float: right;"></div></div>
    				</li>
    				<li>
    					...
    					<div class="form-group">
    						<div class="row">
    							<div class="col-lg-3 col-lg-offset-1">
    								<input class="form-control bg-color" name="clientfirstname" type="text" value="FirstName" readonly>
    							</div>
    							<div class="col-lg-1"  align="center"> = </div>
    							<div class="col-lg-4">
    					...
    					<div class="form-group">
    						<div class="row">
    							<div class="col-lg-3 col-lg-offset-1">
    								<input class="form-control bg-color" name="clientfirstname" type="text" value="LastName" readonly>
    							</div>
    							<div class="col-lg-1"  align="center"> = </div>
    							<div class="col-lg-4">
    								<input class="form-control bg-color" name="contactlastname" type="text" value="~Owner.LastName~" readonly>
    							</div>
    						</div>
    					</div>
    					<div class="form-group">
    						<div class="row">
    							<div class="col-lg-3 col-lg-offset-1">
    								<input class="form-control bg-color" name="clientemail" type="text" value="EmailAddress" readonly>
    							</div>
    							<div class="col-lg-1"  align="center"> = </div>
    							<div class="col-lg-4">
    								<input class="form-control bg-color" name="contactemail" type="text" value="~Owner.Email~" readonly>
    							</div>
    						</div>
    					</div>
    					<div class="row">
