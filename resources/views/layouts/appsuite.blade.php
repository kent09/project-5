...
<html lang="en" ng-app="app">
  ...
  <body id="app-layout" class="fusedsuite">
              ...
              <ul class="nav navbar-nav navbar-right nav-item quick-switch">
                <li class="dropdown selected-module dropup">
                  ...
                  <ul class="dropdown-menu dropdownUser">
                    <li><a href="//tools-beta.fusedsuite.local"><img src="/assets/images/logo/fusedtools.png"></a></li>
                    <li><a href="//docs-beta.fusedsuite.local"><img src="/assets/images/logo/fuseddocs.png"></a></li>
                    <li><a href="//invoices-beta.fusedsuite.local"><img src="/assets/images/logo/fusedinvoice.png"></a></li>
                  </ul>
                </li>
              </ul>
          </div>
