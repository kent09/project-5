...
<html lang="en">
  <head>
    ...
    @hasSection('title')
    <title>@yield('title') - FusedDocs</title>
    @else
    ...
    <link rel="stylesheet" href="{{ url('assets/css/style_docs.css')}}" crossorigin="anonymous">
    <link rel="stylesheet" href="{{ url('assets/css/token-input.css')}}" crossorigin="anonymous">
    <link rel="stylesheet" href="{{ url('assets/css/sidebar_docs.css')}}" crossorigin="anonymous">
    <script>
      var siteUrl = "{{ url('/') }}";
    </script>
    
  </head>
  <body id="app-layout" class="appdocs" style="">
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-10 col-xs-12 links">
            <h4 class="mt-lg-0 mt-sm-3">Pandadocs </h4>
              <ul class="m-0 p-0">
                <li>- <a href="{{ url('/pandadocs') }}">Pandadocs Manager</a></li>
                <li>- <a href="{{ url('/docusign') }}">Docusign Manager</a></li>
                <li>- <a href="{{ url('/pandadocs/setupguide') }}">Pandadocs Guide</a></li>
                <li>- <a href="{{ url('/history') }}">Document History</a></li>
                <li>- <a href="{{ url('/notifications') }}">Document Error log</a></li>
              </ul>
          </div>
